...
double demo_time,demo_time2,demo_time3,demo_time4;
int cnt;
...
void *detect_in_thread(void *ptr)
{
    ...
    double predict_time = what_time_is_it_now();              //
    ...
    double fps4 = (what_time_is_it_now() - predict_time);          //
    ...
    /*
       ...
       avg[i].objectness = 0;
       avg[i].bbox = zero;
       memset(avg[i].prob, 0, classes*sizeof(float));            display_in_thread(0);
    ...
    fps5 = (what_time_is_it_now() - predict_time);

    printf("\033[2J");
    printf("\033[1;1H");
    printf("\nFPS:%.3f   dispaly fps:%.3f   load fps:%.3f yolo fps:%.3f  detect image fps:%.3f\n",1/fps,1/fps2,1/fps3,1/fps4,1/fps5);
    printf("w:%d h:%d\n",buff_letter[(buff_index+2)%3].w,buff_letter[(buff_index+2)%3].h);
    printf("Objects:\n\n");
...
void *fetch_in_thread(void *ptr)
{
    ...
    fps3 = (what_time_is_it_now() - demo_time);
    return 0;
}
...
void demo(char *cfgfile, char *weightfile, float thresh, int cam_index, const char *filename, char **names, int classes, int delay, char *prefix, int avg_frames, float hier, int w, int h, int frames, int fullscreen)
{
    ...
    while(!demo_done){
        ...
        fps2 = (what_time_is_it_now() - demo_time);
